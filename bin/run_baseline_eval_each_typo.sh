...
do
    ...
    rg_output_file=pred/${eval_dataset}/baseline.rg.${model_name_exp}-${typo_type}.json
    ...
    rg_output_score_file=pred/${eval_dataset}/baseline.rg.${model_name_exp}-${typo_type}.json
