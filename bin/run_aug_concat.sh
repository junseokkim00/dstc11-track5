...
CUDA_VISIBLE_DEVICES=${cuda_id} python3 augmentation_concat.py \
        --task selection_aug \
        --params_file /home/jihyunlee/dstc11-track5/augmentation_concat/configs/selection_aug/params.json \
