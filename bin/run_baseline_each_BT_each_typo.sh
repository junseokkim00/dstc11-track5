...
#         model_name_exp=deberta-v3-base-${typol}-${typo}
#         cuda_id=0, 1

#         CUDA_VISIBLE_DEVICES=${cuda_id} python baseline.py \
#                 --task selection \
#                 --dataroot eachBTeachTypo/data/${typol}-${typo} \
...
# do
#     model_name=microsoft/deberta-v3-base
#     model_name_exp=deberta-v3-base-fus-${typo}
#     cuda_id=0,1

#     CUDA_VISIBLE_DEVICES=${cuda_id} python baseline.py \
#             --task selection \
#             --dataroot eachBTeachTypo/data/fus-${typo} \
#             --model_name_or_path ${model_name} \
#             --negative_sample_method "oracle" \
#             --knowledge_file knowledge.json \
#             --params_file baseline/configs/selection/params.json \
...
do
    ...
    do
        ...
        rg_output_file=pred/${eval_dataset}/baseline.rg.${model_name_exp}-${typol}-${typo}.json
        ...
        rg_output_score_file=pred/${eval_dataset}/baseline.rg.${model_name_exp}-${typol}-${typo}.json
